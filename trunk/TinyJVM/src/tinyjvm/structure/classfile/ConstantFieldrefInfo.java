...
public class ConstantFieldrefInfo extends AbstractCPInfo {
    ...
    ConstantFieldrefInfo(final PosDataInputStream posDataInputStream)
            throws IOException {
        super();
        this.tag = AbstractCPInfo.CONSTANT_Fieldref;
    ...
    public String getDescription() {
        return String.format("ConstantFieldrefInfo: Start Position: [%d], length: [%d], value: class_index=[%d], name_and_type_index=[%d].", this.startPos, this.length, this.class_index, this.name_and_type_index);
    }
